...
template void allreduce_bxor<uint8_t>(uint8_t *in, uint8_t *out, size_t size, scope comm);
...
template void allreduce_bxor<uint16_t>(uint16_t *in, uint16_t *out, size_t size, scope comm);
...
template void allreduce_bxor<uint32_t>(uint32_t *in, uint32_t *out, size_t size, scope comm);
...
template void allreduce_bxor<uint64_t>(uint64_t *in, uint64_t *out, size_t size, scope comm);
...
template void allreduce_bxor<float32_t>(float32_t *in, float32_t *out, size_t size, scope comm);
...
template void allreduce_bxor<float64_t>(float64_t *in, float64_t *out, size_t size, scope comm);
...
template void allreduce_bxor<int>(int *in, int *out, size_t size, scope comm);
