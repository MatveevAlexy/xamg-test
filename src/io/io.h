...
void print_residuals_delimiter(const uint16_t nv);

template <typename T>
void print_residuals(const uint32_t iter, const vector::vector &res, const vector::vector &res0,
                     const vector::vector &conv);
template <typename T>
void print_residuals(const uint32_t iter, const std::vector<T> &res_elem,
                     const std::vector<T> &res0_elem, const std::vector<bool> &conv_status);

template <typename T>
void print_residuals(const std::string &prefix, const uint32_t iter, const std::vector<T> &res_elem,
                     const std::vector<T> &res0_elem, const std::vector<bool> &conv_status);
/////////
// helpers:
