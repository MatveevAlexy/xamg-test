...
int XAMG_param_forced_change_value_i(char *solver_type, char *key, uint32_t value,
                                     XAMG_param_id pid);
int XAMG_param_forced_change_value_d(char *solver_type, char *key, double value, XAMG_param_id pid);
...
int XAMG_csr_matrix_alloc(uint64_t, uint64_t, uint64_t, XAMG_csr_matrix_id);
...
int XAMG_solver_print_info(XAMG_solver_id);
int XAMG_solver_get_convergence_info(int *, uint16_t, XAMG_solver_id);
int XAMG_solver_get_iter_info(int *, XAMG_solver_id);
