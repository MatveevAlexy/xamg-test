...
void generate_system(XAMG_csr_matrix_id m_csr_id, XAMG_vector_id x0_id, XAMG_vector_id b0_id,
    ...
    XAMG_csr_matrix_alloc(block_size, nrows, cntr, m_csr_id);
...
int main(int argc, char *argv[]) {
    ...
    XAMG_param_add_value_s("meta_solver", "method", "IterativeRefinement", par_id);
    XAMG_param_add_value_i("meta_solver", "max_iters", 100, par_id);
    XAMG_param_add_value_s("meta_solver", "convergence_details", "check-L2,print", par_id);
    XAMG_param_add_value_b("meta_solver", "subsolver_reduced_precision", 1, par_id);
    XAMG_param_change_value_d("meta_solver", "rel_tolerance", 1.e-6, par_id);
    XAMG_param_change_value_d("meta_solver", "abs_tolerance", 1.e-6, par_id);

    XAMG_param_add_value_s("solver", "method", "PBiCGStab", par_id);
    XAMG_param_add_value_s("preconditioner", "method", "MultiGrid", par_id);
    XAMG_param_add_value_s("solver", "convergence_details", "check-L2,RR,print", par_id);
    XAMG_param_add_value_i("solver", "max_iters", 100, par_id);

    XAMG_param_add_value_s("residual_control", "method", "ResidualReplacement", par_id);
    XAMG_param_add_value_d("residual_control", "RR_deviation", 2.5, par_id);
    XAMG_param_add_value_d("residual_control", "RR_stepping", 0.01, par_id);
    ...
    XAMG_param_change_value_d("meta_solver", "rel_tolerance", 1.e-8, par_id);
    XAMG_param_change_value_d("meta_solver", "abs_tolerance", 1.e-8, par_id);
