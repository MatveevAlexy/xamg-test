...
#define GRAPH_REORDERING_CAPTION "- Flag activating usage of graph partitioning library."
#define GRAPH_REORDERING_DESCR ""

#define SAVE_PATTERN_CAPTION "- Flag to store the input matrix pattern to the eps file."
#define SAVE_PATTERN_DESCR ""
